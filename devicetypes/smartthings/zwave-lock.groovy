	...
	if (cmd.zwaveAlarmType == 6) {
		...
		switch(cmd.zwaveAlarmEvent) {
			...
			case 0xE:
				...
				break
			case 0xF:
				map = [ name: "codeChanged", descriptionText: "$device.displayName: user code not added, duplicate", displayed: true ]
				break
			case 0x10:
			...
			case 0x11:
				...
				break
			case 0x12:
				map = [ name: "codeChanged", descriptionText: "$device.displayName: program code changed", displayed: true ]
				break
			case 0x13:
...
def poll() {
	...
	cmds ?: [[descriptionText: "skipping poll"]]
}
